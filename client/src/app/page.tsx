...
import { ArrowRight, Code, CheckCircle, Zap, Globe, Database, Smartphone, Mail, Phone, MapPin } from 'lucide-react';
      ...
      <main className="flex-grow w-full">
        ...
        <section className="relative min-h-[90vh] flex items-center pt-20 pb-16 md:pt-24 md:pb-20 bg-grid-pattern">
          ...
          <div className="container-custom relative z-10 w-full px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 data-aos="fade-up" data-aos-delay="100" className="text-3xl sm:text-5xl md:text-7xl font-black tracking-tighter mb-8 leading-[1.1] text-black">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
                <div data-aos="fade-up" data-aos-delay="400" className="flex flex-col p-8 rounded-3xl bg-white border border-border shadow-soft hover:shadow-elevated transition-all hover:-translate-y-1">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">Optimized performance for sub-second load times.</p>
                </div>
                <div data-aos="fade-up" data-aos-delay="500" className="flex flex-col p-8 rounded-3xl bg-white border border-border shadow-soft hover:shadow-elevated transition-all hover:-translate-y-1">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">Bank-level encryption for every single transaction.</p>
                </div>
                <div data-aos="fade-up" data-aos-delay="600" className="flex flex-col p-8 rounded-3xl bg-white border border-border shadow-soft hover:shadow-elevated transition-all hover:-translate-y-1">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">Direct access to technical experts 24/7.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-12 border-y border-border bg-secondary/30 overflow-hidden">
          <div className="w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
            <ul className="flex items-center justify-center md:justify-start [&_li]:mx-12 animate-marquee text-muted-foreground font-black text-2xl uppercase tracking-[0.2em] opacity-40">
              ...
              {featuredProducts.map((product: any, idx) => (
                <Link href={`/products/${product.id}`} key={product.id} data-aos="fade-up" data-aos-delay={idx * 100} className="group cursor-pointer bg-white rounded-[2rem] p-5 border border-border hover:border-accent/30 transition-all hover:shadow-2xl">
                  <div className="bg-gray-100 rounded-2xl aspect-[16/10] mb-6 overflow-hidden relative shadow-inner">
                    <img src={product.images[0] || 'https://placehold.co/600x400'} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" alt="" />
                  </div>
                  <div className="px-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="w-10 h-10 rounded-full bg-black text-white flex items-center justify-center group-hover:translate-x-1 transition-transform shadow-lg"><ArrowRight size={18} /></div>
                    </div>
                  </div>
                </Link>
              ))}
        ...
        <section className="py-24 bg-white">
          <div className="container-custom px-4">
            <div data-aos="fade-up" className="text-center max-w-3xl mx-auto mb-20">
              ...
              <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tight">{t('home.help_title')}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} data-aos="fade-up" data-aos-delay={i * 100} className="p-10 rounded-[2.5rem] border border-border bg-secondary/10 hover:bg-white hover:shadow-2xl transition-all group">
                  <div className="w-14 h-14 mb-8 bg-black text-white flex items-center justify-center rounded-2xl group-hover:rotate-6 transition-transform">{s.icon}</div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
            <div className="col-span-1">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed max-w-xs">{t('footer.desc')}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm font-bold text-muted-foreground">
                <li className="flex gap-3 leading-relaxed"><MapPin size={18} className="text-accent shrink-0"/> <span>Cirebon, West Java, Indonesia</span></li>
                <li className="flex items-center gap-3"><Phone size={18} className="text-accent shrink-0"/> <span>08988289551</span></li>
                <li className="flex items-center gap-3"><Mail size={18} className="text-accent shrink-0"/> <span>arfzxcoder@gmail.com</span></li>
              </ul>
            </div>
          </div>
