  ...
  return (
    <div className="flex flex-col min-h-screen bg-background overflow-x-hidden w-full">
      ...
      <main className="flex-grow w-full">
        ...
        <section className="py-24 relative overflow-hidden bg-black text-white mx-4 my-8 rounded-[3rem]">
          <div className="container-custom relative z-10 text-center">
            <h2 data-aos="zoom-in" className="text-3xl md:text-5xl font-bold mb-6">{t('home.start_transform')}</h2>
            <div data-aos="fade-up" data-aos-delay="200" className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
              <Link href="/register" className="px-8 py-4 bg-white text-black rounded-xl font-bold hover:bg-gray-100 transition-colors">{t('home.register_now')}</Link>
              <Link href="/contact" className="px-8 py-4 bg-transparent border border-white/20 text-white rounded-xl font-bold hover:bg-white/10 transition-colors">{t('home.contact_sales')}</Link>
            </div>
          </div>
        </section>
      </main>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-muted-foreground font-medium">
                <li><Link href="/terms" className="hover:text-accent">{t('policy.terms')}</Link></li>
                <li><Link href="/privacy" className="hover:text-accent">{t('policy.privacy')}</Link></li>
                <li><Link href="/refund-policy" className="hover:text-accent">{t('policy.refund')}</Link></li>
                <li><Link href="/faq" className="hover:text-accent">{t('policy.faq')}</Link></li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-border pt-8 text-center text-xs text-muted-foreground font-medium">© 2026 ArfCoder. {t('footer.rights')}</div>
        </div>
      </footer>
    </div>
  );
